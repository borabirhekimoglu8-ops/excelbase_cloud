  ...
  Object.freeze([
    {
      ...
      reason: "Committed text contains a checksum-valid TD3 pair.",
    },
    {
      pageNo: 2,
      ...
      evidence: "text_fixture_expected_output",
      expectedVerified: true,
      reason: "Committed text contains the same checksum-valid TD3 pair.",
    },
    {
      pageNo: 3,
      ...
      reason: "The synthetic surname line is intentionally ambiguous.",
    },
    {
      pageNo: 4,
